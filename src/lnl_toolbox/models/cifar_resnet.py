...
class CifarResNetBottleneck(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.layer1 = self._make_layer(base_width, 3, 1)
        self.layer2 = self._make_layer(base_width * 2, 4, 2)
        self.layer3 = self._make_layer(base_width * 4, 6, 2)
        self.layer4 = self._make_layer(base_width * 8, 3, 2)
