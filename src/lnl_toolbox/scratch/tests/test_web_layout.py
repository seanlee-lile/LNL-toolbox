...
class ScratchInspectorLayoutTest(unittest.TestCase):
    ...
    def test_palette_has_search_and_category_fold_controls(self) -> None:
        ...
        self.assertIn("function deleteSelectedFormulaExpression", javascript)
        self.assertIn("event.key !== 'Backspace'", javascript)
        self.assertIn("formula-editor-dialog", javascript)
        self.assertNotIn("deleteSelectedStep", javascript)
        ...
        self.assertIn("renderFormulaOrIntro(formulaText", javascript)
        ...
        self.assertIn("formula-operation-intro", javascript)
        self.assertIn("function formulaEditorOperationIntro(info)", javascript)
        self.assertIn("formula-palette-disclosure", javascript)
        self.assertIn("全部运算（${candidates.length}）", javascript)
        ...
        self.assertIn('id="formula-output-fields"', html)
        self.assertIn('id="formula-add-output"', html)
        self.assertNotIn('Formula-safe 积木', html)
        self.assertIn('id="formula-expression-structure"', html)
        self.assertIn('id="formula-expression-tree"', html)
        ...
        self.assertIn("function ensureFormulaEditorParameters(info", javascript)
        self.assertIn("parameterValues = {}", javascript)
        self.assertIn("function formulaEditorParameterNode(name, schema", javascript)
        self.assertIn("node.block === 'affine_transform'", javascript)
        self.assertIn("scale); wrapper.append(' × ')", javascript)
        ...
        self.assertIn("function expressionToFormulaSteps", javascript)
        self.assertIn("function formulaStepsToExpression", javascript)
        self.assertIn("function syncFormulaStepsFromExpression", javascript)
        self.assertNotIn('id="formula-equation-builder"', html)
        ...
        self.assertIn("function insertExpressionSymbol", javascript)
        self.assertIn("function addExpressionOperation", javascript)
        self.assertIn("button.onclick = () => addExpressionOperation(info.id)", javascript)
