...
from lnl_toolbox.scratch.web.server import _paper_examples, _template_catalog
from web.command_console import _scratch_examples_payload, _scratch_template_payload
