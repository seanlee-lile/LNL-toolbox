...
| `coteaching` | `coteaching.yaml` | `linear_rate_schedule`, `select_lowest_scores`, `select_by_indices`, `mean_by_indices` | `algorithms/coteaching/`; `training/coteaching_experiment.py` |
...
| `cnlcu` | `cnlcu.yaml` | `create_cnlcu_history`, `append_cnlcu_history`, `cnlcu_soft_robust_mean`, `cnlcu_soft_score`, `select_lowest_scores`, `indices_to_mask` | `algorithms/cnlcu/`; `training/cnlcu_experiment.py` |
