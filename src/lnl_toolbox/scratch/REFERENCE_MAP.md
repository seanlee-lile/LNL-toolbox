...
| `l2rw` | `l2rw.yaml` | `get_next_batch`, `virtual_parameter_update`, `functional_forward_with_state`, `per_sample_ce`, `mean_loss`, `gradient_wrt`, `nonnegative_projection`, `normalize_nonnegative_weights`, `sum_values` | `algorithms/l2rw.py`; `training/l2rw_experiment.py` |
