...
class PreparedData:
    ...
    def validation_uses_train_manifest(self) -> bool:
        """Whether validation targets are derived from the train noise manifest."""
        return (
...
class DataService:
    ...
    def validate_cal_external_labels(
        self, config: Mapping[str, Any]
    ) -> dict[str, Any]:
        """Validate CAL's benchmark label artifact without exposing clean labels."""
